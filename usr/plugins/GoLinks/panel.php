        ...
        <div class="container typecho-page-main">
            <div class="col-mb-12 typecho-list">
                <div class="typecho-option-tabs">
                    <ul class="typecho-option-tabs clearfix" style="text-align: left;">
                        <li class="current"> <?php $ro = Typecho_Router::get('go'); ?>自定义链接样式：<input id="links" name="links" value="<?php echo $ro['url'] ?>" type="text">
                        <button id="qlinks" type="button" class="btn-s primary">修改</button>
                        </li> <br />  <br />                
                        <li class="current">
                           <form action="<?php $options->index('/action/golinks?add'); ?>" method="post" >
                          KEY：<input name="key" id="key" type="text" value="" />&nbsp;&nbsp;&nbsp;&nbsp;
                          目标：<input name="target" id="target" type="text" value="https://" />
